...
const ɵ0 = () => __webpack_require__.e(/*! import() | home-home-module-ngfactory */ "home-home-module-ngfactory").then(__webpack_require__.bind(null, /*! ./home/home.module.ngfactory */ "./src/app/home/home.module.ngfactory.js")).then(m => m.HomeModuleNgFactory);
const routes = [
...
/* harmony import */ var _home_store_reducers_newspost_reducer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./home/store/reducers/newspost.reducer */ "./src/app/home/store/reducers/newspost.reducer.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNewsPosts", function() { return getNewsPosts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNewsPostsSuccess", function() { return getNewsPostsSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidePost", function() { return hidePost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidePostSuccess", function() { return hidePostSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upVotePost", function() { return upVotePost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upVotePostSuccess", function() { return upVotePostSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getNewsPostsFailure", function() { return getNewsPostsFailure; });
...
const getNewsPosts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts] Get news posts', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const getNewsPostsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-success] Get news posts', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const hidePost = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-hide] Hide post', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const hidePostSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-hide-success] Hide post Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const upVotePost = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-upvote] Post Upvote', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const upVotePostSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-upVoteSuccess] Post UpvoteSuccess', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const getNewsPostsFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-failure] Get news posts', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const showLoader = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[news-posts-loader] Show loader', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewsPostFeatureKey", function() { return NewsPostFeatureKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewsPostReducer", function() { return NewsPostReducer; });
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _actions_newspost_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/newspost.action */ "./src/app/home/store/actions/newspost.action.ts");
...
const NewsPostFeatureKey = 'homeModuleStore';
const ɵ0 = (state, action) => {
    return Object.assign(Object.assign({}, state), { newsPost: action.response ? formatData(action.response) : [], chartData: action.response ? formatChartData(action.response) : [], showLoader: false });
}, ɵ1 = (state, action) => {
    return Object.assign(Object.assign({}, state), { newsPost: action.response, chartData: action.response ? formatChartData(action.response) : [] });
}, ɵ2 = (state, action) => {
    return Object.assign(Object.assign({}, state), { newsPost: action.response ? formatData(action.response) : [], chartData: action.response ? formatChartData(action.response) : [] });
}, ɵ3 = (state, action) => {
    return Object.assign(Object.assign({}, state), { showLoader: true });
};
const NewsPostReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_actions_newspost_action__WEBPACK_IMPORTED_MODULE_1__["getNewsPostsSuccess"], ɵ0), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_actions_newspost_action__WEBPACK_IMPORTED_MODULE_1__["hidePostSuccess"], ɵ1), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_actions_newspost_action__WEBPACK_IMPORTED_MODULE_1__["upVotePostSuccess"], ɵ2), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_actions_newspost_action__WEBPACK_IMPORTED_MODULE_1__["showLoader"], ɵ3));
...
function formatData(list) {
    return list.map(el => {
        return Object.assign(Object.assign({}, el), { shortUrl: extractUrl(el.url ? el.url : '') });
    });
}
...
module.exports = __webpack_require__(/*! /Volumes/SamsungSSD/assignment/hacker-news-clone/src/main.ts */"./src/main.ts");
